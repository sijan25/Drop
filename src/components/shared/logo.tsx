...
export function Logo({
  ...
  const cssVars = {
    ...
    '--fd-logo-tile-bg': white
      ? "url('/logo-glyph.png') center/80% no-repeat, linear-gradient(180deg, rgba(255,248,243,0.96) 0%, rgba(248,240,233,0.94) 100%)"
      : "url('/logo-glyph.png') center/80% no-repeat, linear-gradient(180deg, #d9754d 0%, #c96442 100%)",
