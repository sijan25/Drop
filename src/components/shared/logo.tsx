      ...
      <span className={styles.iconWrap} aria-hidden="true">
        <span className={styles.icon}>
          <svg className={[styles.glyph, styles.glyphD].join(' ')} viewBox="0 0 48 48" fill="none">
            <path d="M16 10v28" stroke="var(--fd-logo-glyph-color)" strokeWidth="4.25" strokeLinecap="round" />
            <path d="M16 10c12 0 18 5.5 18 14s-6 14-18 14" stroke="var(--fd-logo-glyph-color)" strokeWidth="4.25" strokeLinecap="round" strokeLinejoin="round" />
          </svg>

          <svg className={[styles.glyph, styles.glyphBag].join(' ')} viewBox="0 0 48 48" fill="none">
            <rect x="14" y="18" width="20" height="18" rx="4.5" stroke="var(--fd-logo-glyph-color)" strokeWidth="3.75" />
            <path d="M18.5 19v-2c0-3.5 2.4-6 5.5-6s5.5 2.5 5.5 6v2" stroke="var(--fd-logo-glyph-color)" strokeWidth="3.75" strokeLinecap="round" />
          </svg>
        </span>
